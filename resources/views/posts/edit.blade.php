<x-app-layout>
  ...
  <div class="py-12">
              ...
              <div class="mb-5">
                ...
                <textarea name="body" id="body"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                      ...
                      dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                      dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                      @error('body') border-red-600 @enderror" required>
	{{ old('body') }}
</textarea>
                @error('body')
                  <div class="text-sm bg-red-200 px-3 py-1 rounded-lg">
   ...
   value="{{ old('published_at', date('Y-m-d')), $post->published_at}}"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                      focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
       dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
       dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
              ...
              <button type="submit"
                class="text-black bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none
